...
5. The terminal will launch. Simply press Enter to confirm — FlashMind AI will immediately start scanning and printing arbitrage opportunities.
...
1. Download the FlashMind_AI_Windows.zip from the [Releases page](https://github.com/flashmind-ai-2026/FlashMind-AI/releases).
2. Extract the ZIP to any folder (e.g., your Desktop).
3. Double‑click FlashMind_AI.exe to launch.  
   *If Windows Defender SmartScreen shows a warning, click "More info" → "Run anyway".*
4. Once the terminal window opens, press Enter to start scanning.
5. To exit, press Enter again in the terminal.
